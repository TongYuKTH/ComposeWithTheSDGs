...
## 5. User Study Materials and Data

This repository also includes materials and data related to the user study reported in the paper.

The user study files are stored in the `user study/` folder.

This folder includes study materials such as:
...
It also includes anonymized user study data used for quantitative and log-based analysis.

Interview recordings and full interview transcripts are not publicly shared in order to protect participant privacy.